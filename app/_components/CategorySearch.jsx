          ...
          <div className="grid grid-cols-1 
            ...
            {filteredMuseums.length > 0 ? (
              filteredMuseums.map((museum) => (
                <div
                  className="relative flex flex-col border rounded-lg p-3
                ...
                >
                  ...
                  <div className="flex flex-col gap-2 flex-1">
                    <h2 className="text-xs bg-primary px-2 py-1 rounded-full
                      text-white text-center w-fit mx-auto">
                      {museum.category}
                    </h2>
                    <h3 className="font-semibold text-lg">{museum.name}</h3>
                    <p className="text-primary text-sm">{museum.established}</p>
                    <p className="text-gray-600 text-sm mb-3">{museum.address}</p>
                    <Link href={`/details/${museum.id}`} passHref>
                      <p className="absolute bottom-2 left-0 w-full px-3 py-2 border border-primary
